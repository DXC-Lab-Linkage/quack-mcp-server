            ...
            async def call_tool(self, name, arguments):
                ...
                if name == "submit_code_for_linting":
                    ...
                    job = self.job_manager.submit_job(
                        JobType.STATIC_ANALYSIS, arguments["code"]
                    )
                    return type(
                        "Response",
                        (),
                    ...
                    result = {"status": job.status.value, "results": job.result}
                    return type(
                        "Response",
                        (),
                        {
                            "content": [
                                type("Content", (), {"text": json.dumps(result)})
                            ]
                        },
                    )
                elif name == "list_jobs":
                ...
                return type(
                    ...
                    (),
                    {
                        "tools": [
                            ...
                            type(
                                "Tool", (), {"name": "submit_code_for_static_analysis"}
                            ),
